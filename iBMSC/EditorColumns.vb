...
Partial Public Class MainWindow
    ...
    Public column() As Column = {New Column(0, 50, "Measure", False, True, False, True, 0, 0, &HFF00FFFF, 0, &HFF00FFFF, 0),
                              ...
                              New Column(225, 40, "A1", True, False, True, True, 16, &HFF808080, &HFF000000, &HFF909090, &HFF000000, 0),
                              New Column(265, 42, "A2", True, False, True, True, 11, &HFFB0B0B0, &HFF000000, &HFFC0C0C0, &HFF000000, &H14FFFFFF),
                              New Column(307, 30, "A3", True, False, True, True, 12, &HFF62B0FF, &HFF000000, &HFF6AB0F7, &HFF000000, &H140033FF),
                              New Column(337, 42, "A4", True, False, True, True, 13, &HFFB0B0B0, &HFF000000, &HFFC0C0C0, &HFF000000, &H14FFFFFF),
                              New Column(379, 45, "A5", True, False, True, True, 14, &HFFFFC862, &HFF000000, &HFFF7C66A, &HFF000000, &H16F38B0C),
                              New Column(424, 42, "A6", True, False, True, True, 15, &HFFB0B0B0, &HFF000000, &HFFC0C0C0, &HFF000000, &H14FFFFFF),
                              New Column(466, 30, "A7", True, False, True, True, 18, &HFF62B0FF, &HFF000000, &HFF6AB0F7, &HFF000000, &H140033FF),
                              New Column(496, 42, "A8", True, False, True, True, 19, &HFFB0B0B0, &HFF000000, &HFFC0C0C0, &HFF000000, &H14FFFFFF),
