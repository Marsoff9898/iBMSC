...
Partial Public Class MainWindow
    ...
    Public Sub RemoveNote(I As Integer, Optional ByVal sortAndUpdatePairing As Boolean = True)
        ...
        If TBWavIncrease.Checked Then
            If Columns.IsColumnSound(Notes(I).ColumnIndex) AndAlso Notes(I).Value = LWAV.SelectedIndex * 10000 Then
                DecreaseCurrentWav()
            End If
            If Columns.IsColumnImage(Notes(I).ColumnIndex) AndAlso Notes(I).Value = LBMP.SelectedIndex * 10000 Then
                DecreaseCurrentBmp()
            End If
        End If
