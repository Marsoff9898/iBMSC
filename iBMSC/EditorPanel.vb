...
Public Class EditorPanel
    ...
    Private Sub DrawTempNote()
        ...
        If _columns.IsColumnSound(_editor.State.Mouse.CurrentMouseColumn) Then
            xValue = (_editor.LWAV.SelectedIndex + 1) * 10000
        Else
            xValue = (_editor.LBMP.SelectedIndex + 1) * 10000
        End If
